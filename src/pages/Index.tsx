  ...
  return <div className="min-h-screen">
      ...
      <div className="min-h-screen bg-gradient-to-b from-primary/10 to-background flex flex-col items-center justify-center">
        <div className="text-center max-w-4xl mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-20 animate-fadeIn">The Interactive Podcast Experience</h1>
          <div className="animate-fadeIn z-50 relative">
            <AudioPlayer audioUrl={defaultEpisode.audioUrl} title={defaultEpisode.title} author={defaultSeries.author} />
          </div>
        </div>
      </div>
