...
class CircleVisualizer {
    constructor() {
        ...
        // Create permanent background shape with teal-green color
        ...
        this.backgroundShape = new Circle(
            ...
            [0.408, 0.682, 0.678, 0.1]  // teal-green (#68aead) with 10% opacity
        );
    ...
    spawnRandomCircle() {
        ...
        while (!validPosition && attempts < 30) {
            ...
            // Random color with teal-green base
            const color = [
                0.408 + Math.random() * 0.1,  // Red component
                0.682 + Math.random() * 0.1,  // Green component
                0.678 + Math.random() * 0.1,  // Blue component
                1.0                           // Alpha component
            ];
        ...
        if (validPosition) {
            const color = [
                0.408 + Math.random() * 0.1,
                0.682 + Math.random() * 0.1,
                0.678 + Math.random() * 0.1,
                1.0
            ];
