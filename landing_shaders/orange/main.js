...
class CircleVisualizer {
    constructor() {
        ...
        // Create permanent background shape with orange color
        ...
        this.backgroundShape = new Circle(
            ...
            [0.910, 0.651, 0.482, 0.1]  // orange (#e8a67b) with 10% opacity
        );
    ...
    spawnRandomCircle() {
        ...
        while (!validPosition && attempts < 30) {
            ...
            // Random color with orange base
            const color = [
                0.910 + Math.random() * 0.1,  // Red component
                0.651 + Math.random() * 0.1,  // Green component
                0.482 + Math.random() * 0.1,  // Blue component
                1.0                           // Alpha component
            ];
        ...
        if (validPosition) {
            const color = [
                0.910 + Math.random() * 0.1,
                0.651 + Math.random() * 0.1,
                0.482 + Math.random() * 0.1,
                1.0
            ];
